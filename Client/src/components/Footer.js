...
const SocialIcon = styled.div`
  ...
  margin-right: 20px;
`;
//passed background color as props bcs evrycolor of icon is different 
...
const Footer = () => {
  return (
    <Container>
        ...
        <Right>
              <Title>Contact</Title>
              <ContactItem><Room style={{marginRight: "10px"}}/>22 Dixie Path, South Tobinchester 98336</ContactItem>
